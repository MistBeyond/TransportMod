...
public class SignalStateResolver {
    ...
    /**
     * Resolves RED/GREEN for every signal. A block signal is directional and protects the next section in its facing
     * direction (docs/roadmap/rail/sections.md), so it turns red only when that specific section is reserved or
     * manually claimed; a blocked section behind the signal keeps it green. On bidirectional track this means
     * signals are needed in both directions.
     */
